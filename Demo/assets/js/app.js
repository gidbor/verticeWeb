(function(){
  ...
  function initScorm(){
    ...
    const fallbackTotal=Math.max(1,structure.length||38);
    ...
    function storeReportedProgress(payload){
      ...
      const sectionTotal=Math.max(1,Number(payload.sectionTotal)||Number(old.packageSectionTotal)||34);
